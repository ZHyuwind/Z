...
parser.add_argument('--resume', default='/home/dev/zy/tracking/SiamMask+SPPE/experiments/siammask_sharp/SiamMask_DAVIS.pth', type=str,
                    metavar='PATH',help='path to latest checkpoint (default: none)')
parser.add_argument('--config', dest='config', default='/home/dev/zy/tracking/SiamMask+SPPE/experiments/siammask_sharp/config_davis.json',
                    help='hyper-parameter of SiamMask in json format')
parser.add_argument('--base_path', default='/home/dev/zy/tracking/SiamMask_modify/file/jump', help='datasets')
